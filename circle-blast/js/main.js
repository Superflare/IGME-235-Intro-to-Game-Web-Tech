...
function fireBullet(e) {
    ...
    if (score >= 5) {
        let tripleBulletOffset = 10;
        let a = new Bullet(0xFFFFFF, ship.x - tripleBulletOffset, ship.y);
        let c = new Bullet(0xFFFFFF, ship.x + tripleBulletOffset, ship.y);
        bullets.push(a);
...
function loadSpriteSheet() {
    // the 16 animations frames ine ach row are 64x64 pixels
